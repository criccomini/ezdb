...
public class TestEzLsmTreeDb {
	...
	public void testRangeH() {
		...
		it.close();
		it = table.range(1);
		assertEquals(new ObjectRangeTableRow<Integer, Integer, Integer>(1, null, 2), it.next());
		assertTrue(it.hasNext());
		assertEquals(new ObjectRangeTableRow<Integer, Integer, Integer>(1, 1, 4), it.next());
		assertTrue(!it.hasNext());
		it.close();
	}
	...
	public void testRangeH0() {
		...
		it.close();
		it = table.range(11, 0);
		assertEquals(new ObjectRangeTableRow<Integer, Integer, Integer>(11, 1, 4), it.next());
		assertTrue(!it.hasNext());
		it.close();
	}
	...
	public void testRangeReverseH() {
		...
		assertEquals(new ObjectRangeTableRow<Integer, Integer, Integer>(11, 1, 4), it.next());
		assertTrue(it.hasNext());
		assertEquals(new ObjectRangeTableRow<Integer, Integer, Integer>(11, null, 2), it.next());
		assertTrue(!it.hasNext());
		it.close();
	}
	...
	public void testRangeHR() {
		...
		assertEquals(new ObjectRangeTableRow<Integer, Integer, Integer>(1, 1, 4), it.next());
		assertTrue(it.hasNext());
		assertEquals(new ObjectRangeTableRow<Integer, Integer, Integer>(1, 2, 5), it.next());
		assertTrue(!it.hasNext());
		it.close();
	...
	public void testRangeHRR() {
		...
		assertEquals(new ObjectRangeTableRow<Integer, Integer, Integer>(1, 2, 5), it.next());
		assertTrue(it.hasNext());
		assertEquals(new ObjectRangeTableRow<Integer, Integer, Integer>(1, 3, 5), it.next());
		assertTrue(!it.hasNext());
		it.close();
	}
	...
	public void testSortedStrings() {
		...
		assertTrue(it.hasNext());
		assertEquals(new ObjectRangeTableRow<Integer, String, Integer>(1213, "20120102-bar", 2), it.next());
		assertTrue(it.hasNext());
		assertEquals(new ObjectRangeTableRow<Integer, String, Integer>(1213, "20120102-foo", 1), it.next());
		assertTrue(!it.hasNext());
		it.close();
	...
	public void testCustomRangeComparator() {
		...
		assertTrue(it.hasNext());
		assertEquals(new ObjectRangeTableRow<Integer, Integer, Integer>(1, 3, 3), it.next());
		assertTrue(it.hasNext());
		assertEquals(new ObjectRangeTableRow<Integer, Integer, Integer>(1, 2, 2), it.next());
		assertTrue(it.hasNext());
		assertEquals(new ObjectRangeTableRow<Integer, Integer, Integer>(1, 1, 1), it.next());
		assertTrue(!it.hasNext());
		it.close();
		table.close();
	}
	...
	public void testVersionedSortedStrings() {
		...
		assertTrue(it.hasNext());
		assertEquals(new ObjectRangeTableRow<Integer, String, Versioned<Integer>>(1213, "20120102-bar",
				new Versioned<Integer>(3, 1)), it.next());
		assertTrue(it.hasNext());
		assertEquals(new ObjectRangeTableRow<Integer, String, Versioned<Integer>>(1213, "20120102-foo",
		...
		it = table.range(1213);
		assertTrue(it.hasNext());
		assertEquals(new ObjectRangeTableRow<Integer, String, Versioned<Integer>>(1213, null,
				new Versioned<Integer>(12345678, 0)), it.next());
		assertTrue(it.hasNext());
		assertEquals(new ObjectRangeTableRow<Integer, String, Versioned<Integer>>(1213, "20120101-foo",
