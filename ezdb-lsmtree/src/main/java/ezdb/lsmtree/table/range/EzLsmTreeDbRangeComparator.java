...
public class EzLsmTreeDbRangeComparator<H, R> implements Comparator<ObjectRangeTableKey<H, R>> {

	private final Comparator<H> hashKeyComparator;
	private final Comparator<R> rangeKeyComparator;

	public EzLsmTreeDbRangeComparator(final Comparator<H> hashKeyComparator, final Comparator<R> rangeKeyComparator) {
