...
import ezdb.leveldb.util.EzLevelDBRangeIterator;
...
public class EzLevelDbRangeTable<H, R, V> implements RangeTable<H, R, V> {
	...
	public EzLevelDbRangeTable(final File path, final EzLevelDbJavaFactory factory, final Serde<H> hashKeySerde,
...
//		}
	...
	public TableIterator<RangeTableRow<H, R, V>> rangeReverse(final H hashKey) {
		...
		final TableIterator<RangeTableRow<H, R, V>> emptyIterator = reverseSeekToLast(hashKey, null, null,
				keyBytesFromBuf, keyBytesFrom, null, iterator, checkKeys);
	...
	private TableIterator<RangeTableRow<H, R, V>> reverseSeekToLast(final H hashKey, final R fromRangeKey,
			final R toRangeKey, final ByteBuf keyBytesFromBuf, final ByteBuffer keyBytesFrom,
			final ByteBuffer keyBytesTo, final EzLevelDBRangeIterator<H, R, V> iterator,
...
//		}
	...
	public RangeBatch<H, R, V> newRangeBatch() {
		return new EzLevelDbJavaRangeBatch<H, R, V>(db, hashKeySerde, rangeKeySerde, valueSerde);
	}
