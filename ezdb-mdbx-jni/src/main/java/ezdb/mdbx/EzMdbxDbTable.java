...
import ezdb.mdbx.util.DBIterator;
import ezdb.mdbx.util.DirectBuffers;
import ezdb.mdbx.util.MdbxDBJniDBIterator;
import ezdb.serde.Serde;
import ezdb.util.Util;

public class EzMdbxDbTable<H, R, V> implements RangeTable<H, R, V> {
	...
	public EzMdbxDbTable(File path, EzMdbxDbFactory factory, Serde<H> hashKeySerde, Serde<R> rangeKeySerde,
		...
		EzMdbxDbComparator comparator = new EzMdbxDbComparator(hashKeyComparator, rangeKeyComparator);
		try {
	...
	public TableIterator<H, R, V> range(H hashKey) {
		final DBIterator iterator = new MdbxDBJniDBIterator(env, db, hashKeyComparator);
	...
	public RangeBatch<H, R, V> newRangeBatch() {
		return new EzMdbxDbBatch<H, R, V>(env, db, hashKeySerde, rangeKeySerde, valueSerde);
	}
