 ...
 * 
 */
public class EzLevelDbJniRangeComparator implements DBComparator {
	public static final String name = EzLevelDbJniRangeComparator.class.toString();

	private final Comparator<ByteBuffer> hashKeyComparator;
	private final Comparator<ByteBuffer> rangeKeyComparator;

	public EzLevelDbJniRangeComparator(final Comparator<ByteBuffer> hashKeyComparator,
