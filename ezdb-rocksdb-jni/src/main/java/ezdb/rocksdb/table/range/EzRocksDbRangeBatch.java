...
public class EzRocksDbRangeBatch<H, R, V> implements RangeBatch<H, R, V> {
	...
	public EzRocksDbRangeBatch(final RocksDB db, final Serde<H> hashKeySerde, final Serde<R> rangeKeySerde,
