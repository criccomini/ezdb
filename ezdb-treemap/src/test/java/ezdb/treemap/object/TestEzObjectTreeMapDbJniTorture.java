...
public class TestEzObjectTreeMapDbJniTorture {
	...
	public static class TortureRunnable implements Runnable {
		...
		private final Db<Object> db;

		public TortureRunnable(final int threadId, final Db<Object> db) {
		...
		public void run() {
			...
			final RangeTable<Integer, Integer, Integer> table = db.getRangeTable(tableName, null, null, null);
